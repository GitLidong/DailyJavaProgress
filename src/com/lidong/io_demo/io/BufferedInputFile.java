...
public class BufferedInputFile {
     ...
     * @param fileName
     * @return
     * @throws IOException 缓冲输入文件：如果要打开文件作为字符输入，可以用FileInputReader。
     *                     为了提高速度，可以对这个文件实行缓冲，用
    ...
    /**
     * @throws IOException StringReader 从内存输入
     */
    ...
    /**
     * @throws IOException 利用 BufferedWriter 向目标写入内容 它被装饰成 PrintWriter
     */
